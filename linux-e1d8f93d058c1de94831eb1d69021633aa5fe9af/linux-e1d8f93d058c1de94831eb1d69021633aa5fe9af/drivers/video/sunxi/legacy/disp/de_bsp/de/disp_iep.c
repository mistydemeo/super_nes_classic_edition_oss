...
__s32 iep_init(__u32 screen_id)
{
	...
	cmu->status = 0;
	cmu->layer_mode = DISP_ENHANCE_MODE_STANDARD;//DISP_ENHANCE_MODE_VIVID;
	cmu->layer_rect.x = 0;
	cmu->layer_rect.y = 0;
	...
	cmu->screen_mode = DISP_ENHANCE_MODE_STANDARD;//DISP_ENHANCE_MODE_VIVID;
	cmu->screen_rect.x = 0;
	cmu->screen_rect.y = 0;
	cmu->screen_rect.width = bsp_disp_get_screen_width(screen_id);
	cmu->screen_rect.height = bsp_disp_get_screen_height(screen_id);
	cmu->screen_bright = gdisp.screen[screen_id].lcd_cfg.lcd_bright;
	cmu->screen_saturation = gdisp.screen[screen_id].lcd_cfg.lcd_saturation;
	cmu->screen_contrast = gdisp.screen[screen_id].lcd_cfg.lcd_contrast;
	cmu->screen_hue = gdisp.screen[screen_id].lcd_cfg.lcd_hue;
