...
static const char *s_ControllerMappings [] =
{
    ...
    "180000004e696e74656e646f20436c00,Nintendo Clovercon,leftx:a0,lefty:a1,rightx:a3,righty:a4,dpup:b13,dpdown:b14,dpleft:b11,dpright:b12,a:b0,b:b1,y:b3,x:b2,back:b8,start:b9,guide:b10,leftshoulder:b4,leftshoulder:a2,rightshoulder:b5,rightshoulder:a5,lefttrigger:b6,righttrigger:b7,",
#endif
