...
#define CONFIG_TARGET_NAME      clover
/*
...
#define CONFIG_SYS_PROMPT		"clover#"
...
#define CONFIG_NAND_LOGIC_START_BLOCK 128 // 16MiB of RAW NAND before logical NAND starts
#define CONFIG_NAND_BOOT_PARTITION_OFFSET 0x8000
#define CONFIG_NAND_SECTORS_PER_BLOCK 256
...
#define CONFIG_USE_NEON_SIMD

#define CONFIG_CLOVER_PLATFORM
