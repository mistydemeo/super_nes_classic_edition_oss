...
macro(CheckMali)
  if(VIDEO_MALI)
    check_c_source_compiles("
        ...
        int main(int argc, char** argv) {}" HAVE_VIDEO_MALI)
    if(HAVE_VIDEO_MALI)
      set(HAVE_SDL_VIDEO TRUE)

      file(GLOB MALI_SOURCES ${SDL2_SOURCE_DIR}/src/video/mali/*.c)
      set(SOURCE_FILES ${SOURCE_FILES} ${MALI_SOURCES})
      set(SDL_VIDEO_DRIVER_MALI 1)
      list(APPEND EXTRA_LIBS Mali)
    endif(HAVE_VIDEO_MALI)
  endif(VIDEO_MALI)
endmacro(CheckMali)
...
macro(CheckDRM)
  if(VIDEO_DRM)
    ...
    if (DRM_FOUND)
      ...
      list(APPEND EXTRA_CFLAGS ${DRM_CFLAGS})
      list(APPEND EXTRA_LDFLAGS ${DRM_LDFLAGS})
      list(APPEND EXTRA_LIBS ${DRM_LIBRARIES})

      file(GLOB DRM_SOURCES ${SDL2_SOURCE_DIR}/src/video/drm/*.c)
      set(SOURCE_FILES ${SOURCE_FILES} ${DRM_SOURCES})

      set(HAVE_SDL_VIDEO TRUE)
      set(HAVE_VIDEO_DRM TRUE)
      set(SDL_VIDEO_DRIVER_DRM 1)
    endif(DRM_FOUND)
  endif(VIDEO_DRM)
endmacro(CheckDRM)
...
macro(CheckOpenGLESX11)
  if(VIDEO_OPENGLES)
    ...
    if(EGL_FOUND)
      ...
      list(APPEND EXTRA_CFLAGS ${EGL_CFLAGS})
      list(APPEND EXTRA_LDFLAGS ${EGL_LDFLAGS})
    ...
    if(GLESv2_FOUND)
      ...
      list(APPEND EXTRA_CFLAGS ${GLESv2_CFLAGS})
      list(APPEND EXTRA_LDFLAGS ${GLESv2_LDFLAGS})
      list(APPEND EXTRA_LIBS ${GLESv2_LIBRARIES})
    endif(GLESv2_FOUND)
