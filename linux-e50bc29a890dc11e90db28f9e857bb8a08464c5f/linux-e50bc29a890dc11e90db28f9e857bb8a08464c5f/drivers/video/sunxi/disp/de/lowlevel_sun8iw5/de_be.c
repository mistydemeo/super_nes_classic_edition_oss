...
__s32 DE_BE_Enable(__u32 sel)
{
	...
	reg_val |= (0x1 << 1);
	DE_BE_WUINT32_MODE_CTL(sel, reg_val);/* start */

	reg_val |= 0x1;
	DE_BE_WUINT32_MODE_CTL(sel, reg_val);/* enable */
...
__s32 DE_BE_Disable(__u32 sel)
{
	...
	reg_val &= 0xfffffffd;
	DE_BE_WUINT32_MODE_CTL(sel, reg_val);/* reset */

	reg_val &= 0xfffffffe;
	DE_BE_WUINT32_MODE_CTL(sel, reg_val);/* disable */
