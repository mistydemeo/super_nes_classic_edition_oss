...
#define SUNXI_IRQ_MAILBOX2GIC             (SUNXI_GIC_START + 52)  /* 84 output from AP_MAILBOX to GIC */
#define SUNXI_IRQ_MAILBOX2PRCM            (SUNXI_GIC_START + 53)  /* 85 output from AP_MAILBOX to PRCM */
...
#define SUNXI_IRQ_C0CTI0                  (SUNXI_GIC_START + 108) /* 140 */
#define SUNXI_IRQ_C0CTI1                  (SUNXI_GIC_START + 109) /* 141 */
#define SUNXI_IRQ_C0CTI2                  (SUNXI_GIC_START + 110) /* 142 */
#define SUNXI_IRQ_C0COMMTX0               (SUNXI_GIC_START + 112) /* 144 */
#define SUNXI_IRQ_C0COMMTX1               (SUNXI_GIC_START + 113) /* 145 */
#define SUNXI_IRQ_C0COMMTX2               (SUNXI_GIC_START + 114) /* 146 */
#define SUNXI_IRQ_C0COMMRX0               (SUNXI_GIC_START + 116) /* 148 */
#define SUNXI_IRQ_C0COMMRX1               (SUNXI_GIC_START + 117) /* 149 */
#define SUNXI_IRQ_C0COMMRX2               (SUNXI_GIC_START + 118) /* 150 */
#define SUNXI_IRQ_C0PMU0                  (SUNXI_GIC_START + 120) /* 152 */
#define SUNXI_IRQ_C0PMU1                  (SUNXI_GIC_START + 121) /* 153 */
#define SUNXI_IRQ_C0PMU2                  (SUNXI_GIC_START + 122) /* 154 */
#define SUNXI_IRQ_C0AXIERR                (SUNXI_GIC_START + 124) /* 156 */
#define SUNXI_IRQ_C0AXIWR                 (SUNXI_GIC_START + 125) /* 157 */
#define SUNXI_IRQ_C0AXIRD                 (SUNXI_GIC_START + 126) /* 158 */
#define SUNXI_IRQ_C1CTI0                  (SUNXI_GIC_START + 128) /* 160 */
#define SUNXI_IRQ_C1CTI1                  (SUNXI_GIC_START + 129) /* 161 */
#define SUNXI_IRQ_C1CTI2                  (SUNXI_GIC_START + 130) /* 162 */
#define SUNXI_IRQ_C1COMMTX0               (SUNXI_GIC_START + 132) /* 164 */
#define SUNXI_IRQ_C1COMMTX1               (SUNXI_GIC_START + 133) /* 165 */
#define SUNXI_IRQ_C1COMMTX2               (SUNXI_GIC_START + 134) /* 166 */
#define SUNXI_IRQ_C1COMMRX0               (SUNXI_GIC_START + 136) /* 168 */
#define SUNXI_IRQ_C1COMMRX1               (SUNXI_GIC_START + 137) /* 169 */
#define SUNXI_IRQ_C1COMMRX2               (SUNXI_GIC_START + 138) /* 170 */
#define SUNXI_IRQ_C1PMU0                  (SUNXI_GIC_START + 140) /* 172 */
#define SUNXI_IRQ_C1PMU1                  (SUNXI_GIC_START + 141) /* 173 */
#define SUNXI_IRQ_C1PMU2                  (SUNXI_GIC_START + 142) /* 174 */
#define SUNXI_IRQ_C1AXIERR                (SUNXI_GIC_START + 144) /* 176 */
#define SUNXI_IRQ_C1AXIWR                 (SUNXI_GIC_START + 145) /* 177 */
#define SUNXI_IRQ_C1AXIRD                 (SUNXI_GIC_START + 146) /* 178 */
#define SUNXI_IRQ_CCI400ERR               (SUNXI_GIC_START + 147) /* 179 */
#define SUNXI_IRQ_CCI400EVENTOF           (SUNXI_GIC_START + 148) /* 180 */
